#!/bin/bash
#SBATCH --job-name=resample_stocks_junk1       # Job name
...
#SBATCH --output=RVTTSV/data/log_appl/job_resample_junk1.out
#SBATCH --error=RVTTSV/data/log_appl/job_resample_junk1.err


Rscript /home/fuchs/agmisc/dimitriadis/RVTTSV/R_appl/resample_stocks_FUCHS_RR2_junk1.R
