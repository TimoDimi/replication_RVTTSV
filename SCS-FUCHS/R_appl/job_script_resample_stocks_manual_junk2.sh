#!/bin/bash
#SBATCH --job-name=resample_stocks_junk2       # Job name
...
#SBATCH --output=RVTTSV/data/log_appl/job_resample_junk2.out
#SBATCH --error=RVTTSV/data/log_appl/job_resample_junk2.err


Rscript /home/fuchs/agmisc/dimitriadis/RVTTSV/R_appl/resample_stocks_FUCHS_RR2_junk2.R
